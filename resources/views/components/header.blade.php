                ...
                <ul class="navbar-nav">
                    <li class="nav-item" style="margin-right: 20px;">
                        <a class="nav-link" aria-current="page" href="/lokasi-train">
                            <i class="fa-solid fa-location-crosshairs fa-fade fa-2xl"></i> Lokasi Kereta
                        </a>
                    </li>
                    <li class="nav-item" style="margin-right: 20px;">
                        <a class="nav-link active" href="/jadwal-train">
                            <i class="fa-solid fa-calendar fa-fade fa-2xl"></i> Jadwal Kereta
                        </a>
                    </li>
                    <li class="nav-item" style="margin-right: 20px;">
                        <a class="nav-link" href="/tarif-train">
